@push('styles')
    <link rel="stylesheet" href="{{ asset('assets/css/components/section5.css') }}">
@endpush
<div class="section5-container">
    <div class="section5-items">
        <h1>A sound approach to buisness</h1>
        <h2>Tendahealth operates in a highly regulated environment and is fully compliant in terms of Financial Advisory
            and Intermediary Services regulations.
            <h2>
                <p>In the interest of our clients we hold professional indemnity cover and have a complaints resolution
                    system in place. Our innovative business model allows us to provide personal care when engaging with
                    clients either through our call centre, online, personal appointments or presentations at corporate
                    forums or meetings.
                </p>
    </div>
    <div class="section5-items">
