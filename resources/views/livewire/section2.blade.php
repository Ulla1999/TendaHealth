...
@endpush
<div class="section2">
    <a href="{{ route('medical-scheme-cover') }}" class="section2-item">
        <img src="{{ asset('assets/img/home/section2-1.jpg') }}">
        <h1>Medical Scheme Cover</h1>
    </a>
    <a href="{{ route('gap-cover') }}" class="section2-item">
        <img src="{{ asset('assets/img/home/section2-2.jpg') }}">
        <h1>GAP cover</h1>
    </a>
    <a href="{{ route('short-term-insurance') }}" class="section2-item">
        <img src="{{ asset('assets/img/home/section2-3.jpg') }}">
        <h1>Short-term Insurance</h1>
    </a>
    <a href="{{ route('investments') }}" class="section2-item">
